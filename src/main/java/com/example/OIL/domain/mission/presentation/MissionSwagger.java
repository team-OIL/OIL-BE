...
public interface MissionSwagger {
    ...
    void completeMission(
            ...
            @Parameter(description = "이미지 파일(Optional)",
                    content = @Content(
    ...
    @ApiResponse(
            responseCode = "200",
            description = "조회 성공",
            content = @Content(array = @ArraySchema(schema = @Schema(implementation = MissionHistoryItemResponse.class)))
    )
